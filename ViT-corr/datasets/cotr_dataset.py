...
class COTRDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        out = {
            ...
            # 'query_image': tvtf.normalize(tvtf.to_tensor(sbs_img[:, 0:256, :]), (0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
            # 'nn_image': tvtf.normalize(tvtf.to_tensor(sbs_img[:, 256:512, :]), (0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
